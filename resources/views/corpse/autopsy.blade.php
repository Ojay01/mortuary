     ...
     <!-- Content wrapper -->
      <div class="content-wrapper">
        ...
        <!-- Content -->
            ...
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Corpse/</span> Autopsy Corpse</h4>

<!-- Basic Layout -->
<!-- Users List Table -->
<div class="card">
  <div class="card-header">
    <h5 class="card-title mb-0">Autopsy Corpse</h5>
  </div>
  <div class="card-datatable table-responsive">
    ...
    <tbody>
   @foreach($autopsyCorpse as $corpse)
<tr class="odd">
    <td class="sorting_1">
