     ...
     <!-- Content wrapper -->
      <div class="content-wrapper">
        ...
        <!-- Content -->
            ...
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Corpse/</span> All Corpse</h4>

<!-- Basic Layout -->
<!-- Users List Table -->
<div class="card">
  <div class="card-header">
    <h5 class="card-title mb-0">Available Corspses</h5>
  </div>
...
@endforeach
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditCorspse" aria-labelledby="offcanvasAddCorspseLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasAddCorspseLabel" class="offcanvas-title">Add Corspse</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body mx-0 flex-grow-0">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="add-user-email" class="form-control" placeholder="corspse room1" aria-label="corspse room1" name="location" required />
    </div>
    <div class="mb-3">
